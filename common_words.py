...
PROMPT_TEMPLATE = """
make this list clear for an ai prompt. pretend you are someone who wants to learn spanish: 

have basic conversation with people. 
talk to someone about soccer.
